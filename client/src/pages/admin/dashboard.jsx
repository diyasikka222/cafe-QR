    ...
    <div className="p-8">
      <div className="flex justify-between items-start mb-8">
        <div>
          ...
          <h2 className="text-5xl font-black">{order.tableNumber}</h2>
        </div>
      ...
      <div className="space-y-4 mb-10 min-h-[140px]">
        {order.items.map((item, i) => (
          <div
            key={i}
            className="flex justify-between items-center border-b border-slate-800/30 pb-3 last:border-0"
          >
            <div className="flex items-center gap-4">
              <span className="w-8 h-8 flex items-center justify-center rounded-xl bg-orange-500/10 text-orange-500 font-black text-sm">
                {item.quantity}
              </span>
      ...
      <div className="pt-8 border-t border-slate-800/50 flex justify-between items-center">
        ...
        <button
          onClick={onComplete}
          className="px-8 py-3.5 rounded-[1.5rem] font-black text-xs uppercase tracking-widest"
        >
